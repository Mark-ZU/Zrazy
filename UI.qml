...
Rectangle{
    ...
    //         }
    //         ComboBox{
    //             model:cmdSender.getCrazySetting(0);
    //             currentIndex : cmdSender.getDefaultIndex(0);
    //             onActivated: cmdSender.sendCrazySetting(0,index);
    //             width:parent.itemWidth;
    //         }
    //         //频率相关
    //         ZText{
    ...
    //         }
    //         ComboBox{
    //             model:cmdSender.getCrazySetting(1);
    //             currentIndex : cmdSender.getDefaultIndex(1);
    //             onActivated: cmdSender.sendCrazySetting(1,index);
    //             width:parent.itemWidth;
    //         }
    //     }
    // }
    ...
    //             cmdSender.closeSerialPort();
    //         }else{
    //             cmdSender.openSerialPort();
    //             cmdSender.sendStartPacket();
    //         }
    ...
    ZGroupBox{
        ...
        Grid{
            ...
            property int dribbleLevel : 6;//DribLevel
            ...
            property int dribbleMaxLevel : 10;//吸球最大等级
            ...
            //cmdSender.updateCommandParams在C++中实现
